...
import { getOutgoingAdoptionRequests, cancelAdoptionRequest } from '../services/adoptionService';
...
const OutgoingRequestsPage = () => {
  ...
  const handleCancel = async (requestId) => {
    ...
    const response = await cancelAdoptionRequest(requestId);
    if (response.success) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Outgoing Requests</h1>
            ...
            <div key={request._id} className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mb-4">
                <p className="text-gray-700">
                  <span className="font-medium">Owner:</span> {request.petId?.owner?.name || 'Unknown'}
                </p>
                <p className="text-gray-700">
              ...
              {request.status === 'pending' && (
                <button
                  ...
                  className="w-full bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 mt-2"
                >
